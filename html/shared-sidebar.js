(function () {
    ...
    function renderSidebar(userInfo) {
        ...
        const active = {
            ...
            forum: isActivePath(currentPath, ['/forum', '/p/forum.html']),
            ...
            album: isActivePath(currentPath, ['/p/rawphoto.html']),
        ...
        nav.innerHTML = `
            ...
            ${navLink('fas fa-users w-5', 'Diễn đàn', '/forum', active.forum)}
            ...
            <div class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 px-3 mt-2">Thư viện</div>
            ${navLink('fas fa-expand', 'Album', '/p/rawphoto.html', active.album)}
